...
class PriorityCacheManager {
  ...
  async get(key) {
    ...
    if (value !== null) {
      ...
      if (currentPriority !== void 0 && currentPriority < CachePriority.CRITICAL) {
  ...
  async promotePriority(key) {
    ...
    if (current === void 0 || current >= CachePriority.CRITICAL) return;
...
export { CachePriority, CostAwareCacheManager, PartitionedCacheManager, PriorityCacheManager, TieredCacheManager, createAdvancedCacheManager };
