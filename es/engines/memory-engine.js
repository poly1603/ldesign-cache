 ...
 * ***********************************
 */
import { CACHE_SIZE, ENGINE_CONFIG, MEMORY_CONFIG, UTF8_SIZE } from '../constants/performance.js';
import { EvictionStrategyFactory } from '../strategies/eviction-strategies.js';
import { BaseStorageEngine } from './base-engine.js';

class MemoryEngine extends BaseStorageEngine {
  /**
   * 构造函数
   *
  ...
  constructor(config) {
    ...
    Object.defineProperty(this, "SIZE_CACHE_LIMIT", {
      ...
      configurable: true,
      writable: true,
      value: CACHE_SIZE.SIZE_CACHE_LIMIT
    });
