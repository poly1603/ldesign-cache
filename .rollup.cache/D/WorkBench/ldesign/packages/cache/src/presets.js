...
const PRESET_CONFIG_MAP = {
    ...
    browser: {
        ...
        strategy: {
            ...
            ttlThresholds: { short: 60000, medium: 3600000, long: 86400000 },
        },
    ...
    offline: {
        ...
        strategy: {
            ...
            ttlThresholds: { short: 5 * 60000, medium: 12 * 60000, long: 7 * 24 * 60000 },
        },
 ...
 * @returns 缓存配置选项
 */
export function getPresetOptions(preset) {
...
export function createBrowserCache(overrides) {
    return new CacheManager({ ...getPresetOptions('browser'), ...overrides });
}
export function createSSRCache(overrides) {
    return new CacheManager({ ...getPresetOptions('ssr'), ...overrides });
}
export function createNodeCache(overrides) {
    return new CacheManager({ ...getPresetOptions('node'), ...overrides });
}
export function createOfflineCache(overrides) {
